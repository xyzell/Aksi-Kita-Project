...
<?php
    $query_total_users = "SELECT COUNT(*) AS total_orders FROM users";
    $stmt_total_users = $conn->prepare($query_total_users);
    $stmt_total_users->execute();
    $stmt_total_users->bind_result($total_users);
    $stmt_total_users->store_result();
    $stmt_total_users->fetch();

    $query_total_campaign = "SELECT COUNT(*) AS total_orders FROM campaign";
    $stmt_total_campaign = $conn->prepare($query_total_campaign);
    $stmt_total_campaign->execute();
    $stmt_total_campaign->bind_result($total_campaign);
    $stmt_total_campaign->store_result();
    $stmt_total_campaign->fetch();

    $query_total_organizer = "SELECT COUNT(*) AS total_orders FROM organizer";
    $stmt_total_organizer = $conn->prepare($query_total_organizer);
    $stmt_total_organizer->execute();
    $stmt_total_organizer->bind_result($total_organizer);
    $stmt_total_organizer->store_result();
    $stmt_total_organizer->fetch();
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Campaign</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php if (isset($total_campaign)) { echo $total_campaign; } ?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php if (isset($total_users)) { echo $total_users; } ?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Organizer</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php if (isset($total_organizer)) { echo $total_organizer; } ?></div>
                                        </div>
                                        <div class="col-auto">

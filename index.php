    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 welcome-text">
          ...
          <p style="text-align: justify;" class="lead">AksiKita didirikan dengan tujuan untuk memobilisasi dan mengkoordinasikan aksi relawan 
      ...
      <div class="row">
        ...
        <div class="col-md-6 pl-md-5">
          ...
          <div class="form-volunteer">
            ...
            <h2>Jadilah Relawan Hari ini !</h2>
